...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hint { font-size: 11.5px; color: #bbb; margin-top: 4px; }
...
<div class="container">
    <div class="card">
        <p class="card-title">Hisob yaratish</p>
        <p class="card-sub">Ro'yxatdan o'ting</p>
        <form method="post" action="${pageContext.request.contextPath}/register">
            ...
            <div class="field">
                ...
                <input type="text" name="username" placeholder="Username" value="<%= request.getParameter("username") != null ? request.getParameter("username") : "" %>">
                <% String usernameErr = (String) request.getAttribute("username_err"); %>
                <% if (usernameErr != null) { %>
                <div class="error-box">&#9888; <%= usernameErr %></div>
                <% } %>
                <p class="hint">Faqat harf va raqamlar</p>
            </div>
            <div class="field">
                <label>PAROL</label>
                <input type="password" name="password" placeholder="••••••••">
                <% String passwordErr = (String) request.getAttribute("password_err"); %>
                <% if (passwordErr != null) { %>
                <div class="error-box">&#9888; <%= passwordErr %></div>
                <% } %>
                <p class="hint">Kamida 6 ta belgi</p>
            </div>
            <button class="btn">Ro'yxatdan o'tish</button>
        </form>
        <div class="sep"><span>yoki</span></div>
        <p class="foot">Hisobingiz bormi? <a href="${pageContext.request.contextPath}/login">Kirish</a></p>
    </div>
</div>
</body>
</html>
